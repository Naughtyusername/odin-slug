// ===================================================
// Slug pixel shader — GLSL 3.30 (OpenGL 3.3)
...
// Matched by name with vertex shader outputs (no layout locations in 3.30 varyings).

     in vec4  outColor;
     in vec2  outTexcoord;     // Em-space sample coordinates
flat in vec4  outBanding;      // Band scale and offset
flat in ivec4 outGlyph;        // Glyph data
...
void main()
{
    vec2 renderCoord = outTexcoord;
    vec4 bandTransform = outBanding;
    ivec4 glyphData = outGlyph;
